...
function PTEToolbar(props) {
  ...
  var selectedPath = (selection === null || selection === void 0 ? void 0 : (_selection$anchor = selection.anchor) === null || _selection$anchor === void 0 ? void 0 : _selection$anchor.path) && (0, _paths.toString)(selection.anchor.path);

  var blockStyleSelectProps = _react.default.useMemo(() => editor ? (0, _helpers.getBlockStyleSelectProps)(editor, selectedPath) : null, [editor, selectedPath]);
